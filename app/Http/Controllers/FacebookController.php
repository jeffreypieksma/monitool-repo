...

{
    ...
    public function __construct(){
        ...
        $this->access_token = 'EAACryEAoP3cBABGATzszPfz5AZA43eTIwaXLG8rVyyT2zaZAMDOyrHgiRRfMxzBv6nKhZBWCGbAv2HD2eUmEMK2WWbZBleMMQNWQhsvMR1pWKxr9vUZAWXR4fBnDgRRpEr1vR0mUzfhsYb0lvMLZATaVji9GVuZCiYZD';
    ...
    public function likesToJS($data){
        ...
        foreach($data[0]['values'] as $value){
            ...
            if(empty($value["value"]["page_profile"])){
                $value["value"]["page_profile"] = '0';
            }
